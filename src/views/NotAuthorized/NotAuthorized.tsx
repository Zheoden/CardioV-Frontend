  ...
  return (
    <div className='flex flex-col h-screen'>
      <div className='flex flex-col my-auto p-16 bg-slate-50 shadow-2xl'>
        <h1 className='mx-auto mb-8 text-2xl font-bold font-mono uppercase'>Usuario No Autorizado</h1>
        <Lottie options={defaultOptions} height={400} width={400} />
        <div className='flex flex-row bg-cyan-500 hover:bg-cyan-700 rounded-full py-2 px-4 w-full mx-auto'>
          <LogoutButton text='Cerrar Sesion' renderIcon />
        </div>
      </div>
    </div>
  );
