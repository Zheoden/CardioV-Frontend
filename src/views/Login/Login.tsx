...
const Login = () => {
  return (
    <div className='flex flex-row h-screen w-screen'>
      <img
        className='w-4/6'
        src='https://media.istockphoto.com/vectors/heart-ultrasound-concept-in-flat-style-vector-vector-id1126809074?k=20&m=1126809074&s=612x612&w=0&h=TxjzEj0Bm_yMxQUVDzzhHi1204DeghXxMtZH7wKY2XI='
      />
      <div className='flex-1 p-16 bg-slate-50 shadow-2xl'>
        <div className='flex flex-col h-full'>
          <div className='flex flex-col my-auto'>
            ...
            <div className='flex flex-row bg-cyan-500 hover:bg-cyan-700 rounded-full py-2 px-4 w-1/2 mx-auto'>
